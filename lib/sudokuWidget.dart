...
import 'package:flutter_sudoku_project/blokChar.dart';
import 'package:flutter_sudoku_project/boxInner.dart';
import 'package:flutter_sudoku_project/focusClass.dart';
...
class _SudokuWidgetState extends State<SudokuWidget> {
  ...
  generatePuzzle() {
    ...
    boxInners.clear();
    var sudokuGenerator = SudokuGenerator(emptySquares: 15); //54
